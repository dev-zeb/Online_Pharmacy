...
<html>
  ...
  <body style='background-color: #F0EEEE;'>
    ...
    echo  "<div class='card'>
            ...
            <h2 style='text-align: left; padding-left: 15px; margin-top: 10px; background-color: lightblue; height: 3rem;'> <i style='color: navy;' class='fas fa-dollar-sign'></i>Total Revenues  : $sum_product BDT</h2>
